...
기준 구현: [base-response.ts](/C:/Users/nihil/coding/app/fa-manager/src/server/utils/base-response.ts), [response.types.ts](/C:/Users/nihil/coding/app/fa-manager/src/server/types/response.types.ts)
...
- 플레이어 목록: [useGetPlayerList.ts](/C:/Users/nihil/coding/app/fa-manager/src/app/composables/players/useGetPlayerList.ts)
  - `GET /api/players`
- 내 플레이어 정보: [useGetMyPlayerInfo.ts](/C:/Users/nihil/coding/app/fa-manager/src/app/composables/players/useGetMyPlayerInfo.ts)
  - `GET /api/players/me`
