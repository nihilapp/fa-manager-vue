...
CREATE TYPE "public"."player_role" AS ENUM('ROLE_USER', 'ROLE_ADMIN', 'ROLE_SUPER_ADMIN');--> statement-breakpoint
CREATE TYPE "public"."player_status" AS ENUM('ACTIVE', 'INACTIVE', 'REST');--> statement-breakpoint
...
CREATE TABLE "players" (
	...
	"name" varchar(50) NOT NULL,
	"role" "player_role" DEFAULT 'ROLE_USER' NOT NULL,
...
--> statement-breakpoint
ALTER TABLE "campaign_members" ADD CONSTRAINT "campaign_members_user_id_players_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."players"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "campaigns" ADD CONSTRAINT "campaigns_user_id_players_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."players"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "characters" ADD CONSTRAINT "characters_user_id_players_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."players"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "currency_transactions" ADD CONSTRAINT "currency_transactions_user_id_players_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."players"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "docs" ADD CONSTRAINT "docs_user_id_players_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."players"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "log_histories" ADD CONSTRAINT "log_histories_user_id_players_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."players"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "session_logs" ADD CONSTRAINT "session_logs_user_id_players_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."players"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "session_players" ADD CONSTRAINT "session_players_user_id_players_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."players"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "idx_sessions_name" ON "sessions" USING btree ("name");